...
export default function Locations() {
  return (
    <div className='px-10 flex flex-col items-center xl:flex-row lg:gap-5 lg:h-[400px]'>
        ...
        <div className='w-full xl:w-[78%] md:h-[350px] gap-8 flex flex-col items-center md:flex-row pt-5 relative'>
            {/*Trip locations*/}
            <div className='md:absolute left-[10px] top-20'>
                <LocationItem
            ...
            <div className='md:absolute left-[110px] top-1/2'>
                <LocationItem
            ...
            <div className='md:absolute left-[210px] top-5'>
                <LocationItem
            ...
            <div className='md:absolute left-[310px] top-2/4 '>
                <LocationItem
            ...
            <div className='md:absolute left-[410px] top-[15%]'>
                <LocationItem
